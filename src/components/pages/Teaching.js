...
export default function Teaching() {
    ...
    return (
        <div className="container my-5">
            ...
            <div className="row mb-4 justify-content-center">
                <div className="col-12">
                    <img src="./assets/images/OpenHouse.jpg" className="rounded img-responsive center-block d-block mx-auto" alt="Me explaining how Stereolithographic 3D printers work" title="Me explaing how Stereolithographic 3D printers work" style={OpenHouseStyle} />
